...
def st():
    ...
    while True:
        ...
        img = cv2.flip(img, 1)
        if qNo<qTotal:
            img = cv2.putText(img, 'Ques: '+str(qNo+1), (50,80), cv2.FONT_HERSHEY_DUPLEX, 2, [222, 208, 204 ])
            img = cv2.putText(img, 'Score: '+str(sc), (900,80), cv2.FONT_HERSHEY_DUPLEX, 2, [222, 208, 204])
